 ...
 */
package com.shihu.demo.springboot.aop.aspects;

import com.shihu.demo.springboot.aop.annotation.BusinessLogAnnotation;
...
public class BusinessLogAspect {
    ...
    @Pointcut(value = "@annotation(com.shihu.demo.springboot.aop.annotation.BusinessLogAnnotation)")
